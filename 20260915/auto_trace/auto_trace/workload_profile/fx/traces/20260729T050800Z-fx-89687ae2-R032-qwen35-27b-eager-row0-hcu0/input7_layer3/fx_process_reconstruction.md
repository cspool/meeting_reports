...
Event: `input7_layer3` (`selected:07`)
Source event: `chatcmpl-bench-7f1746b7-0-9eeec82b|s7|f7|l3|o0`
Observed path: `full_attention`, phase `decode`, q/past/kv = `1/20585/20586`
Trace directory: `/public/home/tangyu408/Qwen_DCU_Worker_0/workload_profile/fx/traces/20260729T050800Z-fx-89687ae2-R032-qwen35-27b-eager-row0-hcu0/input7_layer3`
GraphModule provenance: `fx_graph_module.pt` (SHA-256 `959965bcf907d6dc011886afaf2d33ba36658bf337cc25b92cd8f57a4c0b1365`)
Capture-time nodes: `fx_nodes.json` (SHA-256 `2b6df7cfb808a18c70f6201912f5e3171cc1cce7df446752ff112a393d7dab0f`)
...
unified_kv_cache_update = vllm.unified_kv_cache_update.default(view_11, view_12, 'language_model.model.layers.3.self_attn.attn')
unified_attention_with_output = vllm.unified_attention_with_output.default(view_9, view_11, view_12, view_10, 'language_model.model.layers.3.self_attn.attn', None, None, unified_kv_cache_update)
```
