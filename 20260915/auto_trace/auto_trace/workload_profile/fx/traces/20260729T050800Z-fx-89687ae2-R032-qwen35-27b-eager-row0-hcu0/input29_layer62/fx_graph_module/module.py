...
class FxLayerGraphModule(torch.nn.Module):
    def __init__(self):
        ...
        self.load_state_dict(torch.load(r'/public/home/tangyu408/Qwen_DCU_Worker_0/workload_profile/fx/traces/20260729T050800Z-fx-89687ae2-R032-qwen35-27b-eager-row0-hcu0/input29_layer62/fx_graph_module/state_dict.pt'))
    ...
    def forward(self, arg0_1, arg1_1, arg2_1):
        ...
        gdn_attention_core = torch.ops.vllm.gdn_attention_core.default(getitem, getitem_2, getitem_3, zeros, 'language_model.model.layers.62.linear_attn');  getitem = getitem_2 = getitem_3 = gdn_attention_core = None
