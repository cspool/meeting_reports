...
Event: `input6_layer63` (`selected:05`)
Source event: `chatcmpl-bench-7f1746b7-0-9eeec82b|s6|f6|l63|o0`
Observed path: `full_attention`, phase `prefill_chunk`, q/past/kv = `105/20480/20585`
Trace directory: `/public/home/tangyu408/Qwen_DCU_Worker_0/workload_profile/fx/traces/20260729T050800Z-fx-89687ae2-R032-qwen35-27b-eager-row0-hcu0/input6_layer63`
GraphModule provenance: `fx_graph_module.pt` (SHA-256 `d5aeef639084dc2c9b9504f65e19527530e611f4232d0824f1cb4b38e4013542`)
Capture-time nodes: `fx_nodes.json` (SHA-256 `d86c3ecd166a88af29bd6f657421902be363f4260f4d89bcb2ee3c0dc304c2f6`)
...
view = aten.view.default(getitem, [105, 24, -1])
...
_unsafe_view = aten._unsafe_view.default(clone, [105, 6144])
clone_1 = aten.clone.default(getitem_4,)  # kwargs={'memory_format': torch.contiguous_format}
_unsafe_view_1 = aten._unsafe_view.default(clone_1, [105, 6144])
...
view_5 = aten.view.default(view_2, [105, -1, 256])
...
view_6 = aten.view.default(cat_1, [105, 6144])
view_7 = aten.view.default(view_4, [105, -1, 256])
...
view_8 = aten.view.default(cat_3, [105, 1024])
```

### KV-cache update and unified full attention

```python
empty = aten.empty.memory_format([105, 6144],)  # kwargs={'dtype': torch.bfloat16, 'device': device(type='cuda', index=0), 'pin_memory': False}
...
unified_kv_cache_update = vllm.unified_kv_cache_update.default(view_11, view_12, 'language_model.model.layers.63.self_attn.attn')
unified_attention_with_output = vllm.unified_attention_with_output.default(view_9, view_11, view_12, view_10, 'language_model.model.layers.63.self_attn.attn', None, None, unified_kv_cache_update)
```
...
empty_1 = aten.empty.memory_format([105, 17408],)  # kwargs={'dtype': torch.bfloat16, 'device': device(type='cuda', index=0), 'pin_memory': False}
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | `inputs` | `arg0_1` | `placeholder` | `arg0_1` | `[3, 105]` | `int64` | - | `index` |
...
| 5 | `input_rmsnorm` | `add` | `call_function` | `aten.add.Tensor` | `[105, 5120]` | `bfloat16` | `arg1_1`, `arg2_1` | `_to_copy`, `add_9` |
...
| 15 | `input_rmsnorm` | `_to_copy_2` | `call_function` | `aten._to_copy.default` | `[105, 5120]` | `bfloat16` | `mul_1` | `empty_like`, `mm` |
| 16 | `input_rmsnorm` | `empty_like` | `call_function` | `aten.empty_like.default` | `[105, 5120]` | `bfloat16` | `_to_copy_2` | `copy__4` |
...
| 19 | `qkv_projection` | `mm` | `call_function` | `aten.mm.default` | `[105, 14336]` | `bfloat16` | `_to_copy_2`, `t` | `split_with_sizes` |
| 20 | `qkv_projection` | `split_with_sizes` | `call_function` | `aten.split_with_sizes.default` | `-` | `-` | `mm` | `getitem`, `getitem_1`, `getitem_2` |
| 21 | `qkv_projection` | `getitem` | `call_function` | `<built-in function getitem>` | `[105, 12288]` | `bfloat16` | `split_with_sizes` | `view` |
| 22 | `qkv_projection` | `getitem_1` | `call_function` | `<built-in function getitem>` | `[105, 1024]` | `bfloat16` | `split_with_sizes` | `view_3` |
| 23 | `qkv_projection` | `getitem_2` | `call_function` | `<built-in function getitem>` | `[105, 1024]` | `bfloat16` | `split_with_sizes` | `view_12` |
| 24 | `qkv_projection` | `view` | `call_function` | `aten.view.default` | `[105, 24, 512]` | `bfloat16` | `getitem` | `split` |
| 25 | `qkv_projection` | `split` | `call_function` | `aten.split.Tensor` | `-` | `-` | `view` | `getitem_3`, `getitem_4` |
| 26 | `qkv_projection` | `getitem_3` | `call_function` | `<built-in function getitem>` | `[105, 24, 256]` | `bfloat16` | `split` | `clone` |
| 27 | `qkv_projection` | `getitem_4` | `call_function` | `<built-in function getitem>` | `[105, 24, 256]` | `bfloat16` | `split` | `clone_1` |
| 28 | `qkv_projection` | `clone` | `call_function` | `aten.clone.default` | `[105, 24, 256]` | `bfloat16` | `getitem_3` | `_unsafe_view` |
| 29 | `qkv_projection` | `_unsafe_view` | `call_function` | `aten._unsafe_view.default` | `[105, 6144]` | `bfloat16` | `clone` | `view_1` |
| 30 | `qkv_projection` | `clone_1` | `call_function` | `aten.clone.default` | `[105, 24, 256]` | `bfloat16` | `getitem_4` | `_unsafe_view_1` |
| 31 | `qkv_projection` | `_unsafe_view_1` | `call_function` | `aten._unsafe_view.default` | `[105, 6144]` | `bfloat16` | `clone_1` | `sigmoid` |
| 32 | `qkv_projection` | `view_1` | `call_function` | `aten.view.default` | `[105, 24, 256]` | `bfloat16` | `_unsafe_view` | `_to_copy_3` |
...
| 35 | `qkv_projection` | `_to_copy_3` | `call_function` | `aten._to_copy.default` | `[105, 24, 256]` | `float32` | `view_1` | `mul_2`, `pow_2` |
| 36 | `qkv_projection` | `pow_2` | `call_function` | `aten.pow.Tensor_Scalar` | `[105, 24, 256]` | `float32` | `_to_copy_3` | `mean_1` |
| 37 | `qkv_projection` | `mean_1` | `call_function` | `aten.mean.dim` | `[105, 24, 1]` | `float32` | `pow_2` | `add_3` |
| 38 | `qkv_projection` | `add_3` | `call_function` | `aten.add.Tensor` | `[105, 24, 1]` | `float32` | `mean_1` | `rsqrt_1` |
| 39 | `qkv_projection` | `rsqrt_1` | `call_function` | `aten.rsqrt.default` | `[105, 24, 1]` | `float32` | `add_3` | `mul_2` |
| 40 | `qkv_projection` | `mul_2` | `call_function` | `aten.mul.Tensor` | `[105, 24, 256]` | `float32` | `_to_copy_3`, `rsqrt_1` | `mul_3` |
...
| 43 | `qkv_projection` | `mul_3` | `call_function` | `aten.mul.Tensor` | `[105, 24, 256]` | `float32` | `mul_2`, `add_4` | `_to_copy_5` |
| 44 | `qkv_projection` | `_to_copy_5` | `call_function` | `aten._to_copy.default` | `[105, 24, 256]` | `bfloat16` | `mul_3` | `view_2` |
| 45 | `qkv_projection` | `view_2` | `call_function` | `aten.view.default` | `[105, 6144]` | `bfloat16` | `_to_copy_5` | `view_5` |
| 46 | `qkv_projection` | `view_3` | `call_function` | `aten.view.default` | `[105, 4, 256]` | `bfloat16` | `getitem_1` | `_to_copy_6` |
...
| 49 | `qkv_projection` | `_to_copy_6` | `call_function` | `aten._to_copy.default` | `[105, 4, 256]` | `float32` | `view_3` | `mul_4`, `pow_3` |
| 50 | `qkv_projection` | `pow_3` | `call_function` | `aten.pow.Tensor_Scalar` | `[105, 4, 256]` | `float32` | `_to_copy_6` | `mean_2` |
| 51 | `qkv_projection` | `mean_2` | `call_function` | `aten.mean.dim` | `[105, 4, 1]` | `float32` | `pow_3` | `add_5` |
| 52 | `qkv_projection` | `add_5` | `call_function` | `aten.add.Tensor` | `[105, 4, 1]` | `float32` | `mean_2` | `rsqrt_2` |
| 53 | `qkv_projection` | `rsqrt_2` | `call_function` | `aten.rsqrt.default` | `[105, 4, 1]` | `float32` | `add_5` | `mul_4` |
| 54 | `qkv_projection` | `mul_4` | `call_function` | `aten.mul.Tensor` | `[105, 4, 256]` | `float32` | `_to_copy_6`, `rsqrt_2` | `mul_5` |
...
| 57 | `qkv_projection` | `mul_5` | `call_function` | `aten.mul.Tensor` | `[105, 4, 256]` | `float32` | `mul_4`, `add_6` | `_to_copy_8` |
| 58 | `qkv_projection` | `_to_copy_8` | `call_function` | `aten._to_copy.default` | `[105, 4, 256]` | `bfloat16` | `mul_5` | `view_4` |
| 59 | `qkv_projection` | `view_4` | `call_function` | `aten.view.default` | `[105, 1024]` | `bfloat16` | `_to_copy_8` | `view_7` |
| 60 | `rope` | `_tensor_constant0` | `get_attr` | `_tensor_constant0` | `[1048576, 64]` | `bfloat16` | - | `index` |
| 61 | `rope` | `index` | `call_function` | `aten.index.Tensor` | `[3, 105, 64]` | `bfloat16` | `arg0_1`, `_tensor_constant0` | `split_1` |
| 62 | `rope` | `split_1` | `call_function` | `aten.split.Tensor` | `-` | `-` | `index` | `getitem_5`, `getitem_6` |
| 63 | `rope` | `getitem_5` | `call_function` | `<built-in function getitem>` | `[3, 105, 32]` | `bfloat16` | `split_1` | `select`, `select_1`, `select_2` |
| 64 | `rope` | `getitem_6` | `call_function` | `<built-in function getitem>` | `[3, 105, 32]` | `bfloat16` | `split_1` | `select_3`, `select_4`, `select_5` |
| 65 | `rope` | `select` | `call_function` | `aten.select.int` | `[105, 32]` | `bfloat16` | `getitem_5` | `clone_2` |
| 66 | `rope` | `clone_2` | `call_function` | `aten.clone.default` | `[105, 32]` | `bfloat16` | `select` | `slice_2`, `slice_4`, `unsqueeze`, `unsqueeze_2` |
| 67 | `rope` | `select_1` | `call_function` | `aten.select.int` | `[105, 32]` | `bfloat16` | `getitem_5` | `slice_1` |
| 68 | `rope` | `slice_1` | `call_function` | `aten.slice.Tensor` | `[105, 11]` | `bfloat16` | `select_1` | `copy_` |
| 69 | `rope` | `slice_2` | `call_function` | `aten.slice.Tensor` | `[105, 11]` | `bfloat16` | `clone_2` | `copy_` |
| 70 | `rope` | `copy_` | `call_function` | `aten.copy_.default` | `[105, 11]` | `bfloat16` | `slice_1`, `slice_2` | - |
| 71 | `rope` | `select_2` | `call_function` | `aten.select.int` | `[105, 32]` | `bfloat16` | `getitem_5` | `slice_3` |
| 72 | `rope` | `slice_3` | `call_function` | `aten.slice.Tensor` | `[105, 10]` | `bfloat16` | `select_2` | `copy__1` |
| 73 | `rope` | `slice_4` | `call_function` | `aten.slice.Tensor` | `[105, 10]` | `bfloat16` | `clone_2` | `copy__1` |
| 74 | `rope` | `copy__1` | `call_function` | `aten.copy_.default` | `[105, 10]` | `bfloat16` | `slice_3`, `slice_4` | - |
| 75 | `rope` | `select_3` | `call_function` | `aten.select.int` | `[105, 32]` | `bfloat16` | `getitem_6` | `clone_3` |
| 76 | `rope` | `clone_3` | `call_function` | `aten.clone.default` | `[105, 32]` | `bfloat16` | `select_3` | `slice_6`, `slice_8`, `unsqueeze_1`, `unsqueeze_3` |
| 77 | `rope` | `select_4` | `call_function` | `aten.select.int` | `[105, 32]` | `bfloat16` | `getitem_6` | `slice_5` |
| 78 | `rope` | `slice_5` | `call_function` | `aten.slice.Tensor` | `[105, 11]` | `bfloat16` | `select_4` | `copy__2` |
| 79 | `rope` | `slice_6` | `call_function` | `aten.slice.Tensor` | `[105, 11]` | `bfloat16` | `clone_3` | `copy__2` |
| 80 | `rope` | `copy__2` | `call_function` | `aten.copy_.default` | `[105, 11]` | `bfloat16` | `slice_5`, `slice_6` | - |
| 81 | `rope` | `select_5` | `call_function` | `aten.select.int` | `[105, 32]` | `bfloat16` | `getitem_6` | `slice_7` |
| 82 | `rope` | `slice_7` | `call_function` | `aten.slice.Tensor` | `[105, 10]` | `bfloat16` | `select_5` | `copy__3` |
| 83 | `rope` | `slice_8` | `call_function` | `aten.slice.Tensor` | `[105, 10]` | `bfloat16` | `clone_3` | `copy__3` |
| 84 | `rope` | `copy__3` | `call_function` | `aten.copy_.default` | `[105, 10]` | `bfloat16` | `slice_7`, `slice_8` | - |
| 85 | `rope` | `view_5` | `call_function` | `aten.view.default` | `[105, 24, 256]` | `bfloat16` | `view_2` | `slice_10`, `slice_9` |
| 86 | `rope` | `slice_9` | `call_function` | `aten.slice.Tensor` | `[105, 24, 64]` | `bfloat16` | `view_5` | `split_2` |
| 87 | `rope` | `slice_10` | `call_function` | `aten.slice.Tensor` | `[105, 24, 192]` | `bfloat16` | `view_5` | `cat_1` |
| 88 | `rope` | `unsqueeze` | `call_function` | `aten.unsqueeze.default` | `[105, 1, 32]` | `bfloat16` | `clone_2` | `mul_6`, `mul_8` |
| 89 | `rope` | `unsqueeze_1` | `call_function` | `aten.unsqueeze.default` | `[105, 1, 32]` | `bfloat16` | `clone_3` | `mul_7`, `mul_9` |
| 90 | `rope` | `split_2` | `call_function` | `aten.split.Tensor` | `-` | `-` | `slice_9` | `getitem_7`, `getitem_8` |
| 91 | `rope` | `getitem_7` | `call_function` | `<built-in function getitem>` | `[105, 24, 32]` | `bfloat16` | `split_2` | `mul_6`, `mul_9` |
| 92 | `rope` | `getitem_8` | `call_function` | `<built-in function getitem>` | `[105, 24, 32]` | `bfloat16` | `split_2` | `mul_7`, `mul_8` |
| 93 | `rope` | `mul_6` | `call_function` | `aten.mul.Tensor` | `[105, 24, 32]` | `bfloat16` | `unsqueeze`, `getitem_7` | `sub` |
| 94 | `rope` | `mul_7` | `call_function` | `aten.mul.Tensor` | `[105, 24, 32]` | `bfloat16` | `unsqueeze_1`, `getitem_8` | `sub` |
| 95 | `rope` | `sub` | `call_function` | `aten.sub.Tensor` | `[105, 24, 32]` | `bfloat16` | `mul_6`, `mul_7` | `cat` |
| 96 | `rope` | `mul_8` | `call_function` | `aten.mul.Tensor` | `[105, 24, 32]` | `bfloat16` | `unsqueeze`, `getitem_8` | `add_7` |
| 97 | `rope` | `mul_9` | `call_function` | `aten.mul.Tensor` | `[105, 24, 32]` | `bfloat16` | `unsqueeze_1`, `getitem_7` | `add_7` |
| 98 | `rope` | `add_7` | `call_function` | `aten.add.Tensor` | `[105, 24, 32]` | `bfloat16` | `mul_8`, `mul_9` | `cat` |
| 99 | `rope` | `cat` | `call_function` | `aten.cat.default` | `[105, 24, 64]` | `bfloat16` | `sub`, `add_7` | `cat_1` |
| 100 | `rope` | `cat_1` | `call_function` | `aten.cat.default` | `[105, 24, 256]` | `bfloat16` | `slice_10`, `cat` | `view_6` |
| 101 | `rope` | `view_6` | `call_function` | `aten.view.default` | `[105, 6144]` | `bfloat16` | `cat_1` | `view_9` |
| 102 | `rope` | `view_7` | `call_function` | `aten.view.default` | `[105, 4, 256]` | `bfloat16` | `view_4` | `slice_11`, `slice_12` |
| 103 | `rope` | `slice_11` | `call_function` | `aten.slice.Tensor` | `[105, 4, 64]` | `bfloat16` | `view_7` | `split_3` |
| 104 | `rope` | `slice_12` | `call_function` | `aten.slice.Tensor` | `[105, 4, 192]` | `bfloat16` | `view_7` | `cat_3` |
| 105 | `rope` | `unsqueeze_2` | `call_function` | `aten.unsqueeze.default` | `[105, 1, 32]` | `bfloat16` | `clone_2` | `mul_10`, `mul_12` |
| 106 | `rope` | `unsqueeze_3` | `call_function` | `aten.unsqueeze.default` | `[105, 1, 32]` | `bfloat16` | `clone_3` | `mul_11`, `mul_13` |
| 107 | `rope` | `split_3` | `call_function` | `aten.split.Tensor` | `-` | `-` | `slice_11` | `getitem_10`, `getitem_9` |
| 108 | `rope` | `getitem_9` | `call_function` | `<built-in function getitem>` | `[105, 4, 32]` | `bfloat16` | `split_3` | `mul_10`, `mul_13` |
| 109 | `rope` | `getitem_10` | `call_function` | `<built-in function getitem>` | `[105, 4, 32]` | `bfloat16` | `split_3` | `mul_11`, `mul_12` |
| 110 | `rope` | `mul_10` | `call_function` | `aten.mul.Tensor` | `[105, 4, 32]` | `bfloat16` | `unsqueeze_2`, `getitem_9` | `sub_1` |
| 111 | `rope` | `mul_11` | `call_function` | `aten.mul.Tensor` | `[105, 4, 32]` | `bfloat16` | `unsqueeze_3`, `getitem_10` | `sub_1` |
| 112 | `rope` | `sub_1` | `call_function` | `aten.sub.Tensor` | `[105, 4, 32]` | `bfloat16` | `mul_10`, `mul_11` | `cat_2` |
| 113 | `rope` | `mul_12` | `call_function` | `aten.mul.Tensor` | `[105, 4, 32]` | `bfloat16` | `unsqueeze_2`, `getitem_10` | `add_8` |
| 114 | `rope` | `mul_13` | `call_function` | `aten.mul.Tensor` | `[105, 4, 32]` | `bfloat16` | `unsqueeze_3`, `getitem_9` | `add_8` |
| 115 | `rope` | `add_8` | `call_function` | `aten.add.Tensor` | `[105, 4, 32]` | `bfloat16` | `mul_12`, `mul_13` | `cat_2` |
| 116 | `rope` | `cat_2` | `call_function` | `aten.cat.default` | `[105, 4, 64]` | `bfloat16` | `sub_1`, `add_8` | `cat_3` |
| 117 | `rope` | `cat_3` | `call_function` | `aten.cat.default` | `[105, 4, 256]` | `bfloat16` | `slice_12`, `cat_2` | `view_8` |
| 118 | `rope` | `view_8` | `call_function` | `aten.view.default` | `[105, 1024]` | `bfloat16` | `cat_3` | `view_11` |
| 119 | `kv_cache_attention` | `empty` | `call_function` | `aten.empty.memory_format` | `[105, 6144]` | `bfloat16` | - | `view_10` |
| 120 | `kv_cache_attention` | `view_9` | `call_function` | `aten.view.default` | `[105, 24, 256]` | `bfloat16` | `view_6` | `unified_attention_with_output` |
| 121 | `kv_cache_attention` | `view_10` | `call_function` | `aten.view.default` | `[105, 24, 256]` | `bfloat16` | `empty` | `unified_attention_with_output`, `view_13` |
| 122 | `kv_cache_attention` | `view_11` | `call_function` | `aten.view.default` | `[105, 4, 256]` | `bfloat16` | `view_8` | `unified_attention_with_output`, `unified_kv_cache_update` |
| 123 | `kv_cache_attention` | `view_12` | `call_function` | `aten.view.default` | `[105, 4, 256]` | `bfloat16` | `getitem_2` | `unified_attention_with_output`, `unified_kv_cache_update` |
...
| 126 | `attention_output` | `view_13` | `call_function` | `aten.view.default` | `[105, 6144]` | `bfloat16` | `view_10` | `mul_14` |
| 127 | `attention_output` | `sigmoid` | `call_function` | `aten.sigmoid.default` | `[105, 6144]` | `bfloat16` | `_unsafe_view_1` | `mul_14` |
| 128 | `attention_output` | `mul_14` | `call_function` | `aten.mul.Tensor` | `[105, 6144]` | `bfloat16` | `view_13`, `sigmoid` | `mm_1` |
...
| 131 | `output_projection` | `mm_1` | `call_function` | `aten.mm.default` | `[105, 5120]` | `bfloat16` | `mul_14`, `t_1` | `copy__4` |
| 132 | `output_projection` | `copy__4` | `call_function` | `aten.copy_.default` | `[105, 5120]` | `bfloat16` | `empty_like`, `mm_1` | `add_9` |
...
| 135 | `output_projection` | `add_9` | `call_function` | `aten.add.Tensor` | `[105, 5120]` | `bfloat16` | `add`, `copy__4` | `_to_copy_9`, `output` |
| 136 | `post_attention_rmsnorm` | `_to_copy_9` | `call_function` | `aten._to_copy.default` | `[105, 5120]` | `float32` | `add_9` | `mul_15`, `pow_4` |
| 137 | `post_attention_rmsnorm` | `pow_4` | `call_function` | `aten.pow.Tensor_Scalar` | `[105, 5120]` | `float32` | `_to_copy_9` | `mean_3` |
| 138 | `post_attention_rmsnorm` | `mean_3` | `call_function` | `aten.mean.dim` | `[105, 1]` | `float32` | `pow_4` | `add_10` |
| 139 | `post_attention_rmsnorm` | `add_10` | `call_function` | `aten.add.Tensor` | `[105, 1]` | `float32` | `mean_3` | `rsqrt_3` |
| 140 | `post_attention_rmsnorm` | `rsqrt_3` | `call_function` | `aten.rsqrt.default` | `[105, 1]` | `float32` | `add_10` | `mul_15` |
| 141 | `post_attention_rmsnorm` | `mul_15` | `call_function` | `aten.mul.Tensor` | `[105, 5120]` | `float32` | `_to_copy_9`, `rsqrt_3` | `mul_16` |
...
| 144 | `post_attention_rmsnorm` | `mul_16` | `call_function` | `aten.mul.Tensor` | `[105, 5120]` | `float32` | `mul_15`, `add_11` | `_to_copy_11` |
| 145 | `post_attention_rmsnorm` | `_to_copy_11` | `call_function` | `aten._to_copy.default` | `[105, 5120]` | `bfloat16` | `mul_16` | `mm_2` |
...
| 148 | `mlp` | `mm_2` | `call_function` | `aten.mm.default` | `[105, 34816]` | `bfloat16` | `_to_copy_11`, `t_2` | `silu_and_mul` |
| 149 | `mlp` | `empty_1` | `call_function` | `aten.empty.memory_format` | `[105, 17408]` | `bfloat16` | - | `mm_3`, `silu_and_mul` |
...
| 153 | `mlp` | `mm_3` | `call_function` | `aten.mm.default` | `[105, 5120]` | `bfloat16` | `empty_1`, `t_3` | `output` |
