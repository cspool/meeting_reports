...
class FxLayerGraphModule(torch.nn.Module):
    def __init__(self):
        ...
        self.load_state_dict(torch.load(r'/public/home/tangyu408/Qwen_DCU_Worker_0/workload_profile/fx/traces/20260729T050800Z-fx-89687ae2-R032-qwen35-27b-eager-row0-hcu0/input6_layer63/fx_graph_module/state_dict.pt'))
    ...
    def forward(self, arg0_1, arg1_1, arg2_1):
        ...
        view = torch.ops.aten.view.default(getitem, [105, 24, -1]);  getitem = None
        ...
        _unsafe_view = torch.ops.aten._unsafe_view.default(clone, [105, 6144]);  clone = None
        clone_1 = torch.ops.aten.clone.default(getitem_4, memory_format = torch.contiguous_format);  getitem_4 = None
        _unsafe_view_1 = torch.ops.aten._unsafe_view.default(clone_1, [105, 6144]);  clone_1 = None
        ...
        view_5 = torch.ops.aten.view.default(view_2, [105, -1, 256]);  view_2 = None
        ...
        view_6 = torch.ops.aten.view.default(cat_1, [105, 6144]);  cat_1 = None
        view_7 = torch.ops.aten.view.default(view_4, [105, -1, 256]);  view_4 = None
        ...
        view_8 = torch.ops.aten.view.default(cat_3, [105, 1024]);  cat_3 = None
        empty = torch.ops.aten.empty.memory_format([105, 6144], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        ...
        unified_kv_cache_update = torch.ops.vllm.unified_kv_cache_update.default(view_11, view_12, 'language_model.model.layers.63.self_attn.attn')
        unified_attention_with_output = torch.ops.vllm.unified_attention_with_output.default(view_9, view_11, view_12, view_10, 'language_model.model.layers.63.self_attn.attn', None, None, unified_kv_cache_update);  view_9 = view_11 = view_12 = unified_kv_cache_update = unified_attention_with_output = None
        ...
        empty_1 = torch.ops.aten.empty.memory_format([105, 17408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
