...
class FxLayerGraphModule(torch.nn.Module):
    def __init__(self):
        ...
        self.load_state_dict(torch.load(r'/public/home/tangyu408/Qwen_DCU_Worker_0/workload_profile/fx/traces/20260729T050800Z-fx-89687ae2-R032-qwen35-27b-eager-row0-hcu0/input2_layer31/fx_graph_module/state_dict.pt'))
