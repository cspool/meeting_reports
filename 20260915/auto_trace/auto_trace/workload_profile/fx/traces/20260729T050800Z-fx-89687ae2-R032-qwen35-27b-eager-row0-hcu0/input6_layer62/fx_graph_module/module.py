...
class FxLayerGraphModule(torch.nn.Module):
    def __init__(self):
        ...
        self.load_state_dict(torch.load(r'/public/home/tangyu408/Qwen_DCU_Worker_0/workload_profile/fx/traces/20260729T050800Z-fx-89687ae2-R032-qwen35-27b-eager-row0-hcu0/input6_layer62/fx_graph_module/state_dict.pt'))
    ...
    def forward(self, arg0_1, arg1_1, arg2_1):
        ...
        view = torch.ops.aten.view.default(getitem_1, [105, 48, 128]);  getitem_1 = None
        ...
        zeros = torch.ops.aten.zeros.default([105, 48, 128], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        gdn_attention_core = torch.ops.vllm.gdn_attention_core.default(getitem, clone, clone_1, zeros, 'language_model.model.layers.62.linear_attn');  getitem = clone = clone_1 = gdn_attention_core = None
        ...
        _unsafe_view = torch.ops.aten._unsafe_view.default(clone_2, [5040, 128]);  clone_2 = None
        ...
        view_2 = torch.ops.aten.view.default(_to_copy_6, [105, 48, 128]);  _to_copy_6 = None
        view_3 = torch.ops.aten.view.default(view_2, [105, 6144]);  view_2 = None
        ...
        add_4 = torch.ops.aten.add.Tensor(copy_, add);  copy_ = add = None
        _to_copy_7 = torch.ops.aten._to_copy.default(add_4, dtype = torch.float32)
        ...
        add_6 = torch.ops.aten.add.Tensor(_to_copy_8, 1.0);  _to_copy_8 = None
        mul_6 = torch.ops.aten.mul.Tensor(mul_5, add_6);  mul_5 = add_6 = None
        ...
        empty = torch.ops.aten.empty.memory_format([105, 17408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
